            ...
            <div class="row content">
                <div class="col s12">
                    <div class="col s6">
                        ...
                        <p>Esperamos atender às suas necessidades e facilitar suas relações com as empresas.</p>
                    </div>
                </div>
            </div>
            <div class="contact">
                <div class="row">
                    <div class="col s12 disclaimer">
                        <p>Em caso de dúvidas, sugestões, ou reclamações, envie um email para suporte@ondetem-gn.com.br</p>
                        <p>Boas Buscas!</p>
                    </div>
                </div>
                <div class="row">
