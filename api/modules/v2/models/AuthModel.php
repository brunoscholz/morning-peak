...
use api\components\MultiModel;
use api\components\RestUtils;

/**
 * AuthModel represents the model behind the search form about common\models\AuthToken.
 */
class AuthModel extends MultiModel
{
    ...
    {
        $this->modelClass = 'AuthModel' //api\modules\v2\models\;
        parent::init();
    }
