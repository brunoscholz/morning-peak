...
{   
    ...
    {
        $fileManagerInstance = AppAdaptor::app()->assetManager->getResourceManagerInstance($type, $config);
    ...
    {
        $fileManagerInstance = AppAdaptor::app()->assetManager->getResourceManagerInstance('image', $htmlOptions);
    ...
    public static function getThumbnailImage($model, $attribute, $htmlOptions = [])
    {
        ...
        $fileManagerInstance = AppAdaptor::app()->assetManager->getResourceManagerInstance('image', $config);
    ...
    public static function saveCustomImage($model, $attribute, $width, $height)
    {
        ...
        $imageManager = AppAdaptor::app()->assetManager->getResourceManagerInstance('image', $config);
        $imageManager->saveSizedImage();
    }
    
    /**
     * Delete image.
     * @param \base\library\utils\Model $model
     * @param string $attribute
     * @param int $width
     * @param int $height
    ...
    {
        $config = ['model' => $model, 'attribute' => $attribute];
        $fileManager = AppAdaptor::app()->fileManager;
